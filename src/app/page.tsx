...
import { Loader2, Heart, Truck, Star, ShieldCheck, ChefHat, MessageCircle } from 'lucide-react';
    ...
    <div className="flex flex-col">
      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative mx-auto px-6 text-center z-10">
          ...
          >
            <h1 className="text-5xl md:text-8xl lg:text-9xl font-black tracking-tighter text-white mb-6 drop-shadow-2xl">
              Budines <span className="text-secondary">Noemi</span>
            </h1>
            <p className="text-lg md:text-2xl text-white/90 font-medium max-w-2xl mx-auto mb-10 leading-relaxed drop-shadow">
      ...
      <section className="py-24 bg-secondary/10">
        <div className="container mx-auto px-6 max-w-3xl">
          <h2 className="text-3xl md:text-4xl font-black text-center mb-12 uppercase tracking-tighter">Preguntas Frecuentes</h2>
      ...
      <section className="py-32 bg-primary relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10 text-center text-primary-foreground space-y-8">
          <motion.h2 className="text-5xl md:text-7xl font-black tracking-tight" {...fadeIn}>
            ¿Listo para merendar?
          </motion.h2>
          <motion.div {...fadeIn} className="pt-8 flex flex-col sm:flex-row justify-center gap-4">
            <Button asChild size="lg" variant="secondary" className="px-12 py-8 text-xl font-black rounded-full shadow-2xl hover:scale-105 transition-transform">
              <Link href="#productos">PEDIR AHORA</Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="px-10 py-8 text-lg font-bold rounded-full bg-white/10 border-white/20 text-white hover:bg-white/20 transition-all">
